...
export default function AboutSection() {
  return (
    <section id="about" className="relative py-20 md:py-28 bg-section-light">
      {/* Stats Bar */}
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          <ScrollReveal direction="left">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-[#0a1628] rounded-2xl p-6 shadow-xl">
                <div className="text-3xl font-bold gradient-text">25+</div>
                <div className="text-gray-400 text-sm">Years of Trust</div>
              </div>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal direction="right">
            <div>
              ...
              <h2 className="mt-3 text-3xl md:text-4xl lg:text-5xl font-bold text-[#0a1628] leading-tight">
                A Legacy of{' '}
              ...
              <p className="mt-4 text-gray-600 text-base md:text-lg leading-relaxed">
                ...
                healthcare that meets and exceeds global standards. Every treatment plan is
                designed with the patient at its centre, blending advanced technology with
              ...
              <div className="flex items-center gap-4 mt-8">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-gray-700">JCI Certified</span>
                </div>
              </div>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal>
            <div className="max-w-3xl mx-auto text-center mb-16">
              <div className="glass-light rounded-2xl p-8 md:p-12">
                <Target className="w-10 h-10 text-[#d4a853] mx-auto mb-4" />
                <h3 className="text-xl md:text-2xl font-bold text-[#0a1628] mb-4">Our Mission</h3>
            ...
            {values.map((val, i) => (
              <ScrollReveal key={val.title} delay={i * 0.1}>
                <motion.div
                  ...
                  className="bg-white rounded-2xl p-6 md:p-8 shadow-lg border border-gray-100 card-hover text-center"
                >
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-[#0a1628] to-[#132040] flex items-center justify-center mx-auto mb-4">
                    <val.icon className="w-7 h-7 text-[#d4a853]" />
                  </div>
      ...
      {/* Timeline */}
      <div className="bg-section-light py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <ScrollReveal>
            <div className="text-center mb-14">
              <span className="text-[#d4a853] text-sm font-semibold tracking-wider uppercase">
          ...
          <div className="relative">
            {/* Center Line */}
            <div className="hidden md:block absolute left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-[#d4a853] via-[#3b82f6] to-[#0d9488]" />
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {leadership.map((person, i) => (
              <ScrollReveal key={person.name} delay={i * 0.1}>
                <motion.div
                  whileHover={{ y: -8 }}
                  className="bg-gradient-to-b from-[#0a1628] to-[#132040] rounded-2xl p-6 text-center card-hover"
                >
                  <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#d4a853] to-[#e8c97a] flex items-center justify-center mx-auto mb-4">
                    <Stethoscope className="w-10 h-10 text-[#0a1628]" />
                  </div>
                  <h3 className="text-white font-bold text-lg">{person.name}</h3>
                  <p className="text-[#d4a853] text-sm mt-1">{person.role}</p>
