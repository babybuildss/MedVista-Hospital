            ...
            >
              <div className="p-6 pt-24">
                <div className="flex flex-col gap-2">
                  {navLinks.map((link, i) => (
                    <motion.button
                      key={link.href}
                      onClick={() => scrollToSection(link.href)}
                      className="text-left px-4 py-3 text-navy font-medium rounded-xl hover:bg-gray-50 transition-colors"
                ...
                <div className="mt-6 pt-6 border-t border-gray-100">
                  ...
                  <button
                    onClick={() => scrollToSection('#contact')}
                    className="w-full mt-3 px-5 py-3 bg-gradient-to-r from-gold to-gold-light text-navy font-semibold rounded-xl"
                  >
                    Book Appointment
                  </button>
                </div>
